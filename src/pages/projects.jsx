...
export default function Projects() {
  ...
  return (
    <Container className="content border border-danger d-flex flex-column align-items-center py-4">
      ...
      {active && customCarrousel(testCard.freela)}
      {!active && customCard(testCard.freela)}
      <h2 className="title mt-5">Trybe</h2>
      <h4 className="mt-2">Fundamentos</h4>
      <Row>HTML-CSS-JS</Row>
      <Row>
        {active && customCarrousel(testCard.fundamentos)}
        {!active && customCard(testCard.fundamentos)}
      </Row>
      ...
      {active && customCarrousel(testCard.fundamentos)}
      {!active && customCard(testCard.frontEnd)}
